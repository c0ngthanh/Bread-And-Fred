...
public class PlayerRope : NetworkBehaviour
{
    ...
    private NetworkVariable<SkillState> skillState = new NetworkVariable<SkillState>(SkillState.Unlocked);
    ...
    private void MoveServerRpc()
    {
        if (IsServer)
        {
            ...
            {
                rb.AddForce(new Vector2(this.dirX.Value, 0) * 40);
            }
        }
    }
    [ServerRpc(RequireOwnership = false)]
